...
# DIST = getenv("DIST")  # Distributed training
# HALF = getenv("HALF")  # Use BF16

# BS = getenv("BS", 32)  # Batch size
# EPOCHS = getenv("EPOCHS", 30)  # Number of epochs
# STEPS = getenv("STEPS", 100000)  # Number of steps

# EVAL_BS = getenv("EVAL_BS", 8)  # Evaluation batch size
# MAX_EVAL_STEPS = getenv("MAX_EVAL_STEPS", 100)  # Number of evaluation steps
...
# loss = Tensor.sparse_categorical_crossentropy(logits, labels)
